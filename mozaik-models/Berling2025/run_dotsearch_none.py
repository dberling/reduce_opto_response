...
from experiments_dotsearch import *
import mozaik
...
data_store, model = run_workflow(
    'SelfSustainedPushPull', SelfSustainedPushPull, lambda model : create_experiments_central_stimulation_morphology(model,"None"))
data_store.save()
