...
radius = 150
intensity = 0.0722222222222222
data_store, model = run_workflow(
    'SelfSustainedPushPull', SelfSustainedPushPull, lambda model: create_experiments_central_stimulation_morphology(model, "m2", radius, intensity))
data_store.save()
